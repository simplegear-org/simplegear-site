...
const strings = {
  en: {
    ...
    privacy: {
      metaTitle: 'PeerLink Privacy Policy',
      metaDescription: 'PeerLink privacy policy for chats, calls, media, and server configuration sharing.',
      eyebrow: 'Privacy Policy',
      title: 'PeerLink Privacy Policy',
      effectiveDate: 'Effective date: July 29, 2026',
      intro: 'PeerLink is an open-source messenger for private chats, calls, media, and self-hosted communication infrastructure. This policy explains what data may be processed and how server configuration information is shared.',
      back: 'Back to PeerLink',
      ...
      sharingBody: 'We do not sell personal data. Data may be processed by self-hosted servers you choose, by PeerLink infrastructure endpoints configured in the app, and by service providers used to operate hosting, delivery, diagnostics, or security.',
  ...
  ru: {
    ...
    privacy: {
      metaTitle: 'Политика конфиденциальности PeerLink',
      metaDescription: 'Политика конфиденциальности PeerLink для чатов, звонков, медиа и обмена конфигурацией серверов.',
      eyebrow: 'Политика конфиденциальности',
      title: 'Политика конфиденциальности PeerLink',
      effectiveDate: 'Дата вступления в силу: 29 июля 2026',
      intro: 'PeerLink — мессенджер с открытым исходным кодом для приватных чатов, звонков, медиа и собственной коммуникационной инфраструктуры. Эта политика объясняет, какие данные могут обрабатываться и как передается информация о конфигурации серверов.',
      back: 'Назад к PeerLink',
      ...
      sharingBody: 'Мы не продаем персональные данные. Данные могут обрабатываться выбранными вами self-hosted серверами, инфраструктурными endpoint-ами PeerLink, настроенными в приложении, и поставщиками сервисов для хостинга, доставки, диагностики или безопасности.',
  ...
  es: {
    ...
    privacy: {
      metaTitle: 'Política de privacidad de PeerLink',
      metaDescription: 'Política de privacidad de PeerLink para chats, llamadas, multimedia y uso compartido de configuración de servidores.',
      eyebrow: 'Política de privacidad',
      title: 'Política de privacidad de PeerLink',
      effectiveDate: 'Fecha de entrada en vigor: 29 de julio de 2026',
      intro: 'PeerLink es un mensajero de código abierto para chats privados, llamadas, multimedia e infraestructura de comunicación autoalojada. Esta política explica qué datos pueden procesarse y cómo se comparte la información de configuración de servidores.',
      back: 'Volver a PeerLink',
      ...
      sharingBody: 'No vendemos datos personales. Los datos pueden ser procesados por servidores autoalojados que elijas, por endpoints de infraestructura PeerLink configurados en la app y por proveedores usados para hosting, entrega, diagnóstico o seguridad.',
  ...
  zh: {
    ...
    privacy: {
      metaTitle: 'PeerLink 隐私政策',
      metaDescription: 'PeerLink 关于聊天、通话、媒体和服务器配置共享的隐私政策。',
      eyebrow: '隐私政策',
      title: 'PeerLink 隐私政策',
      effectiveDate: '生效日期：2026 年 7 月 29 日',
      intro: 'PeerLink 是一款开源通讯应用，支持私密聊天、通话、媒体分享和自托管通信基础设施。本政策说明可能处理哪些数据，以及服务器配置信息如何共享。',
      back: '返回 PeerLink',
      dataTitle: '我们处理的数据',
      ...
      sharingTitle: '数据共享',
      sharingBody: '我们不出售个人数据。数据可能由你选择的自托管服务器、应用中配置的 PeerLink 基础设施 endpoint，以及用于托管、投递、诊断或安全的服务提供商处理。',
      retentionTitle: '数据保留',
  ...
  fr: {
    ...
    privacy: {
      metaTitle: 'Politique de confidentialité PeerLink',
      metaDescription: 'Politique de confidentialité PeerLink pour les chats, appels, médias et le partage de configuration des serveurs.',
      eyebrow: 'Politique de confidentialité',
      title: 'Politique de confidentialité PeerLink',
      effectiveDate: 'Date d’effet : 29 juillet 2026',
      intro: 'PeerLink est une messagerie open source pour les discussions privées, les appels, les médias et l’infrastructure de communication auto-hébergée. Cette politique explique quelles données peuvent être traitées et comment les informations de configuration des serveurs sont partagées.',
      back: 'Retour à PeerLink',
      ...
      sharingBody: 'Nous ne vendons pas de données personnelles. Les données peuvent être traitées par les serveurs auto-hébergés que vous choisissez, par les endpoints d’infrastructure PeerLink configurés dans l’app et par des fournisseurs utilisés pour l’hébergement, la livraison, le diagnostic ou la sécurité.',
