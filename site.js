...
const strings = {
  en: {
    ...
    home: {
      ...
      metaDescription: 'PeerLink X is an open-source messenger for encrypted chats, calls, media, and self-hosted communication infrastructure.',
      heroEyebrow: 'Open-source encrypted messenger',
      lead: 'Encrypted direct and group messaging, calls, media sharing, and self-hosted communication servers.',
      trustTitle: 'Public code',
      ...
      privateTitle: 'Encrypted by design',
      privateBody: 'PeerLink X focuses on peer identity, end-to-end encrypted messaging, calls, and media with public app and server code.',
      ...
      aboutBody: 'PeerLink X is an open-source encrypted messenger for direct chats, group chats, calls, media, and self-hosted network servers.',
    ...
    privacy: {
      ...
      intro: 'PeerLink X is an open-source messenger for encrypted chats, calls, media, and self-hosted communication infrastructure. This policy explains what data may be processed and how server configuration information is shared.',
      ...
      dataMessages: 'End-to-end encrypted chat content is stored locally on user devices; servers may process routing metadata, encrypted media metadata, call state, and delivery state needed for messaging and calls.',
  ...
  ru: {
    ...
    home: {
      ...
      metaDescription: 'PeerLink X — мессенджер с открытым исходным кодом для шифрованных чатов, звонков, медиа и собственной коммуникационной инфраструктуры.',
      heroEyebrow: 'Open-source мессенджер с шифрованием',
      lead: 'Шифрованные личные и групповые сообщения, звонки, обмен медиа и собственные коммуникационные серверы.',
      trustTitle: 'Открытый код',
      ...
      privateTitle: 'Шифрование в основе',
      privateBody: 'PeerLink X строится вокруг peer-идентичности, end-to-end шифрованных сообщений, звонков и медиа с открытым кодом приложения и серверов.',
      ...
      aboutBody: 'PeerLink X — мессенджер с открытым исходным кодом и шифрованием для личных и групповых чатов, звонков, медиа и собственных сетевых серверов.',
      sourceEyebrow: 'Open source',
    ...
    invite: {
      ...
      metaDescription: 'Откройте приглашение PeerLink X или узнайте больше об open-source мессенджере с шифрованием.',
    ...
    pair: {
      ...
      metaDescription: 'Откройте ссылку привязки PeerLink X или узнайте больше об open-source мессенджере с шифрованием.',
    ...
    config: {
      ...
      metaDescription: 'Откройте ссылку конфигурации серверов PeerLink X или узнайте больше об open-source мессенджере с шифрованием.',
    ...
    privacy: {
      ...
      intro: 'PeerLink X — мессенджер с открытым исходным кодом для шифрованных чатов, звонков, медиа и собственной коммуникационной инфраструктуры. Эта политика объясняет, какие данные могут обрабатываться и как передается информация о конфигурации серверов.',
      ...
      dataMessages: 'Содержимое чатов защищено end-to-end шифрованием и хранится локально на устройствах пользователей; серверы могут обрабатывать routing-метаданные, зашифрованные метаданные медиа, состояние звонков и доставки, необходимые для сообщений и звонков.',
  ...
  es: {
    ...
    home: {
      ...
      privateTitle: 'Cifrado por diseño',
      privateBody: 'PeerLink X se centra en la identidad peer, mensajes cifrados end-to-end, llamadas y multimedia con código público de la app y los servidores.',
    ...
    privacy: {
      ...
      dataMessages: 'El contenido de los chats está protegido con cifrado end-to-end y se almacena localmente en los dispositivos; los servidores pueden procesar metadatos de enrutamiento, metadatos multimedia cifrados, estado de llamadas y estado de entrega necesarios para mensajes y llamadas.',
  ...
  zh: {
    ...
    home: {
      ...
      privateTitle: '以加密为核心',
      privateBody: 'PeerLink X 专注于 peer 身份、端到端加密消息、通话和媒体，并公开应用和服务器代码。',
      selfHostTitle: '适合自托管',
    ...
    privacy: {
      ...
      dataMessages: '聊天内容受端到端加密保护，并本地存储在用户设备上；服务器可能处理消息和通话所需的路由元数据、加密媒体元数据、通话状态和投递状态。',
  ...
  fr: {
    ...
    home: {
      ...
      privateTitle: 'Chiffré par conception',
      privateBody: 'PeerLink X met l’accent sur l’identité peer, les messages chiffrés end-to-end, les appels et les médias avec un code app et serveur public.',
    ...
    privacy: {
      ...
      dataMessages: 'Le contenu des chats est protégé par chiffrement end-to-end et stocké localement sur les appareils des utilisateurs ; les serveurs peuvent traiter les métadonnées de routage, les métadonnées média chiffrées, l’état des appels et l’état de livraison nécessaires à la messagerie et aux appels.',
